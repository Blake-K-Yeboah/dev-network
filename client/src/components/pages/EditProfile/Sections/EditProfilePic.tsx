...
const EditProfilePic = inject('authStore')(observer(({ authStore }: IStoreProps) => {
    ...
    const uploadProfilePic = () => {
        ...
        Axios.put(`/api/users/${authStore.user.id}/profilepic`, formData).then(res => {
    ...
    return (
        <div className="edit-profile-pic">
            ...
            <div className="content">
                ...
                <button className="btn warning" onClick={uploadProfilePic}>Update Profile</button>
